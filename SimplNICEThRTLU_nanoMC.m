function Out = SimplNICEThRTLU_nanoMC(ESi,DISPLAY,tNICE,t,Q1,h1,r1,Q2,h2,r2,CmR,Gna,Vna,Gk,Vk,Gl,Vl,...
    GT,VT,hinf,tauh,rinf,taur,minf,pinf,VLIMs,Cm0,aBLS,fBLS,RSI,proteinMode,gateMultip)
if DISPLAY == 2
...
if (V1<VLIMs(1)||V2<VLIMs(1)||V1>VLIMs(2)||V2>VLIMs(2)), error('Error: transmembrane potential outside interpolation interval!'); end
Out1 = [ESi(t)+10^(-3)*(1/(pi*aBLS^2*(V2-V1)))-10^(-3)*(xl*Gl*(V1-Vl)+xP*Gna*minf(V1).^3.*h1.*(V1-Vna)+...
